...
int operador(int metodo,int quantidade,int situacao,int chave,char *flagP, int argc, char *argv[]);
    ...
    case 1:
        ...
        case 1: //Arquivo crescente
            ...
            if (pesquisaCrescente (tabela, pos, &x, arq, &busca)){ //realiza a busca sequencial em arquivo ordenado crescente
                ...
                if(!(strcmp(flagP, "-P"))){ //se for opção do usuário, imprime no terminal as chaves do arquivo
